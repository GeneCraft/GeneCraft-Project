...
OgreBulletManager::OgreBulletManager(QObject *parent) :
    QObject(parent)
{
}
using namespace Ogre;
void OgreBulletManager::init(OgreManager* ogre) {
    ...
    mSceneMgr = ogre->getSceneManager();
...
int cpt = 99;
void OgreBulletManager::oneStep() {
    qDebug() << "physic step";
    cpt++;
    if(cpt%30 == 0) {
        qDebug() << "adding a box !";
        ...
        Camera* mCamera = ogre->getSceneManager()->getCamera("ow" + 0);
