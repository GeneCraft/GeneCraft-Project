...
OgreBulletDynamics::RigidBody *SandboxTools::addBox(OgreEngine* ogre, BulletEngine *bulletMgr,
...
OgreBulletDynamics::RigidBody *SandboxTools::addSphere(OgreEngine* ogre,
                                                       BulletEngine *bulletMgr,
...
OgreBulletDynamics::RigidBody *SandboxTools::addCylinder(OgreEngine* ogre, BulletEngine *bulletMgr,
